    ...
    <div class="breadcrumbs-custom context-dark bg-overlay-60">
        <div class="container">
            ...
            <ul class="breadcrumbs-custom-path">
                ...
                <li><a href="/?r=stainedglass">Витражи</a></li>
                <li><a href="/?r=stainedglass&category_label=<?= $currentCategory['label'] ?>"><?= $currentCategory['name'] ?></a></li>
                ...
                <div class="blog-post">
                    ...
                    <article class="post post-classic text-justify">
                        ...
                        <div class="post-classic-panel group-middle justify-content-start">
                            <a class="badge badge-secondary" href="/?r=stainedglass&category_label=<?= $currentCategory['label'] ?>">
